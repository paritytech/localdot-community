...
VITE_ASSET_HUB_ENDPOINT=                 # WSS for Revive contract calls (default: AH Next)
VITE_BULLETIN_ENDPOINT=                  # WSS for Bulletin storage (default: Bulletin Next)
VITE_PEOPLE_CHAIN_ENDPOINT=              # WSS for Statement Store subscribe (default: People Next)
VITE_IPFS_GATEWAY=                       # Bulletin IPFS gateway (default: paseo-bulletin-next-ipfs)
